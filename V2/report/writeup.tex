...
\author{Pearl Apply Pay \and Cow Peh Cow Moo Sheng Yan \and Tan Ee Khai\\[2pt]
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Men's training:} 2015--2025 excluding 2020 (the cancelled COVID tournament); 11 seasons, 742 matchup pairs. The 2015 start ensures no season requires Barttorvik imputation.
...
After backward elimination, the final feature sets contain 38 features for men and 31 for women.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{LOSO ensemble averaging} (Section \ref{sec:alternatives}). Each ensemble member saw only 10 of 11 men's seasons, losing roughly 10\,\% of training data per member. Variance reduction did not compensate.
